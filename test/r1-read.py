...
def send_get_request(api_url):
    headers = get_headers_sigv4a(boto3.Session(), "execute-api", '*', "GET", api_url)
    httprequest = Request(api_url, headers=headers)
...
api_url = f"{base_url}/orders?orderId={order}&productId={product}"
